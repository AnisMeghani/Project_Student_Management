...
console.log(`Course fee for ${studentInput.courses}: ${courseFee[studentInput.courses]}`);
...
if (course_fees === amount_payment) {
    console.log(`Congratulations! You have successfully paid for ${studentInput.courses}`);
